...
public class AppelJourPersonnelService {
	...
	public void ajouteAuListeAbsence(long personnel_id, Date date, AppelJourPersonnel ap) throws MessagingException {
...
//						+ "                                </table>\n" + "                              </td>\n"
//						+ "                            </tr>\n" + "                          </tbody>\n"
//						+ "                        </table>\n" + "                        <p>Merci de nous contacter et de vérifier votre raison d'absence </p>\n"
//						+ "                        <p>Cordialement.</p>\n"
//						+ "                        <p> CIMS.</p>\n" + "                      </td>\n"
//						+ "                    </tr>\n" + "                  </table>\n" + "                </td>\n"
...
//						+ "                    <span class=\"apple-link\">CIMS,Tunisie</span>\n"
//						+ "                  </td>\n" + "                </tr>\n" + "                <tr>\n"
...
//				  javaMailSender.send(message);	
	...
	public void envoyermail() throws MessagingException{
		...
		for (Absence a : listeallpersonnelabsent)
		{
			...
			MimeMessage message = javaMailSender.createMimeMessage();
			   MimeMessageHelper helper = new MimeMessageHelper(message, true);
			   helper.setTo(personnelRepository.getEmailparNometPrenom(a.getNom(), a.getPrenom())); 
			   helper.setFrom("consommis.toounsi.619@gmail.com");
			   helper.setSubject("Verification absence");
			   helper.setText(messaage, messaage);
			  javaMailSender.send(message);	
